...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateCursorMaskPreview = () => {
        ...
        // Use the explicitly defined themeCol to ensure perfect color matching
        cursorBg.style.background = `linear-gradient(135deg, ${nextConfig.themeCol} 0%, rgba(${hexToRgb(nextConfig.themeCol)}, 0.4) 100%)`;
        cursorBg.style.filter = 'none'; // Remove hue-rotate to avoid double-shifting the colors
    };
